    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-item {{ Request::is('book') ? 'active' : '' }}">
        <a href="{{ route('book.index') }}" class="menu-link ">
          ...
          <div data-i18n="Boxicons">Daftar Buku</div>
        </a>
      </li>
